    ...
    <div className="">
      ...
      <button className="mt-4 text-xl font-bold" onClick={() => (setDisplay(false),setCreateProjectButton(true))}>
        ...
        <div className="flex justify-evenly space-x-4">
          ...
          <button className="rounded-md px-3 py-2 border-dark hover:bg-white hover:text-dark hover:border-2 ">Filter </button>
          <button className="bg-secondary px-3 py-2 rounded-md text-white border-dark hover:bg-white hover:text-dark hover:border-2 ">Generate Report</button>
        </div>
      </div>
